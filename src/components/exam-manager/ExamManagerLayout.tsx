                        ...
                        notifications.map((n) => (
                          <button
                            ...
                            onClick={() => {
                              ...
                              if (
                                n.title.includes("AI") ||
                                n.title.includes("cấu hình") ||
                                n.title.includes("Cấu hình")
                              ) {
                                navigate("/exam-manager/ai-config");
                              }
                              ...
                              if (
                                ...
                                navigate("/exam-manager/stats");
                              }

                              if (
                                n.title.includes("câu hỏi") ||
                                n.title.includes("ngân hàng") ||
                                n.title.includes("Câu hỏi")
                              ) {
